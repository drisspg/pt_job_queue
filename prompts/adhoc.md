...
IMPORTANT: Always generate report.md before finishing. Generate pr_title.txt and pr_labels.txt if the result is PR-worthy. Generate fix.diff if you made any code changes.
